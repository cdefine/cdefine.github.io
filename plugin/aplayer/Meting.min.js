...
class MetingJSElement extends HTMLElement {
    ...
    _init() {
        ...
        // 更换 api
        this.config = a, this.api = this.meta.api || window.meting_api || 'https://api.mlwei.com/music/api/wy/?key=523077333&cache=1&type=:type&id=:id'
    }
    _parse_link() {
        let a = [
    ...
    _parse() {
        ...
        //修改api
        // a = "https://api.mlwei.com/music/api/wy/?key=523077333&cache=1&type=songlist&id=164643234"
